...
void HeadingHold::setTarget(double target) { targetHeading = target; }
...
EncoderOdometry::EncoderOdometry(pros::MotorGroup &leftMotors,
    ...
    : m_leftMotorGroup(leftMotors), m_rightMotorGroup(rightMotors),
      m_wheelCirc(wheelDiam * M_PI), m_gearRatio(gearRatio) {}
